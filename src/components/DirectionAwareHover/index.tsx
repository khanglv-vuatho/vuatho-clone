...
export const DirectionAwareHover = ({ children, className }: { children?: React.ReactNode; className?: string }) => {
  ...
  return (
    <motion.div onMouseEnter={handleMouseEnter} ref={ref} className={cn('relative h-60 w-60 overflow-hidden rounded-lg bg-transparent md:h-96 md:w-96', className)}>
