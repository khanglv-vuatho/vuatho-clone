    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={twMerge(
            `fixed bottom-0 left-0 right-0 top-[70px] z-[1000] flex h-[calc(100dvh-70px)] flex-col items-start gap-4 overflow-hidden p-2 3xl:top-[80px] 3xl:h-[calc(100dvh-80px)] ${origin[direction]}`,
            className
          )}
        >
          {children}
