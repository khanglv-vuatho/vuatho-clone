...
import { Logo } from '@/app/[locale]/(mainLayout)/(layout)/header'
...
export const MacbookScroll = ({ src, showGradient, title, badge }: { src?: string; showGradient?: boolean; title?: string | React.ReactNode; badge?: React.ReactNode }) => {
  ...
  return (
    <div ref={ref} className='flex min-h-[200dvh] w-full flex-shrink-0 transform flex-col items-center justify-start py-0 [perspective:800px] md:py-80'>
      <motion.h2
        style={{
  ...
  return (
    <div className='relative [perspective:800px]'>
      ...
      >
        ...
        <Image src={src as string} alt='aceternity logo' fill className='absolute inset-0 h-full w-full rounded-lg object-cover object-left-top' />
      </motion.div>
    </div>
  )
}
  ...
  return (
    <div className='mx-1 h-full rounded-md bg-[#050505] p-1'>
      ...
      <Row>
        ...
        <KBtn isVuaTho={true}>
          <span className='block text-primary-yellow'>T</span>
        </KBtn>
        <KBtn>
          <span className='block'>Y</span>
        </KBtn>
        <KBtn isVuaTho={true}>
          <span className='block text-primary-yellow'>U</span>
        </KBtn>
        <KBtn>
          <span className='block'>I</span>
        </KBtn>
        <KBtn isVuaTho={true}>
          <span className='block text-primary-yellow'>O</span>
        </KBtn>
        <KBtn>
      ...
      <Row>
        ...
        <KBtn isVuaTho={true}>
          <span className='block text-primary-yellow'>A</span>
        </KBtn>
        ...
        <KBtn isVuaTho={true}>
          <span className='block text-primary-yellow'>H</span>
        </KBtn>
        <KBtn>
      ...
      <Row>
        ...
        <KBtn isVuaTho={true}>
          <span className='block text-primary-yellow'>V</span>
        </KBtn>
        <KBtn>
...
export const KBtn = ({
  ...
  return (
    <motion.button
      ...
      viewport={{ once: true }}
      className={cn('rounded-[4px] p-[0.5px] duration-150 active:scale-90', backlit && 'bg-white/20 shadow-xl shadow-white')}
    >
      <div
...
const AceternityLogo = () => {
  // return <ImageFallback src={'/logo/logo.svg'} alt='Logo nav' width={256} height={176} className='pointer-events-none h-[60px] w-auto object-contain 3xl:h-[70px]' />
  return (
    <div className='flex flex-col items-center gap-2'>
      <ImageFallback src={'/logo/logo.svg'} alt='Logo nav' width={256} height={176} className='pointer-events-none h-[60px] w-auto object-contain 3xl:h-[70px]' />
      <p className='text-2xl font-bold text-white'>Thợ nào cũng có!</p>
    </div>
  )
}
