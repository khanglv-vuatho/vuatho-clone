...
function DrawerExample({ children }: Props) {
  ...
  return (
    <div style={{ padding: 40 }}>
      ...
      <Drawer expanded={expanded} header={'Bottom sheet'} onChange={setExpanded}>
        {children}
      </Drawer>
    </div>
  )
...
export const BottomSheet = () => (
  <DrawerExample>
    <p style={{ lineHeight: 2 }}>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum ac mauris sit
      amet diam pulvinar vestibulum. Sed malesuada ultrices hendrerit.
    </p>
