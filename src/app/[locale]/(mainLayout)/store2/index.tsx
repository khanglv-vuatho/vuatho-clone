  ...
  return (
    <>
      ...
      <DefaultModal
        ...
        className='overflow-y-auto md:mt-[140px] md:h-[80dvh]'
      />
    </>
  )
})
  ...
  return (
    <>
      <Button
        onPress={onOpen}
        variant='bordered'
        className='h-10 items-center gap-2 border-[#FCB713] text-base text-[#FCB713]'
        startContent={
          <Badge
            content={!!cartItems?.length || 0}
            placement='top-right'
            classNames={{
              badge: 'bg-[#FF4343] text-white h-4 w-4 text-[1rem] right-[20%] top-[20%] border-0'
            }}
          >
            <Bag2 size={24} />
          </Badge>
      ...
      modalBody={
        <div className='flex flex-col gap-4 p-5'>
          ...
          <div className='flex flex-col items-center gap-4'>
            ...
            <p className='text-xl '>{isSuccess ? t('text18') : t('text30')}</p>
          </div>
        </div>
      }
    />
