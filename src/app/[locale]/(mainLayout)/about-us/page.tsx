  ...
  return (
    <div className=' w-full'>
      ...
      <div className='relative h-[400px] w-full bg-[#f6f8fa] xl:h-[600px] xl:bg-transparent'>
        <div className='w-full'>
          <Image src={'/images/about-us/people.png'} alt='people' width={2700} height={584} className='pointer-events-none absolute bottom-0 left-0 right-0 top-0 hidden xl:block' />
        </div>
